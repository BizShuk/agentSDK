...
func TestRegisterFuncCall(t *testing.T) {
	...
	action.RegisterFunc(r, "echo", "echo back the message", core.RISK_LEVEL_LOW,
...
func TestRegisterFuncError(t *testing.T) {
	r := action.NewRegistry()
	action.RegisterFunc(r, "fail", "always fails", core.RISK_LEVEL_LOW,
		func(ctx context.Context, a echoArgs) (echoOut, error) {
...
func TestRegistry(t *testing.T) {
	r := action.NewRegistry()
	action.RegisterFunc(r, "read_log_tail", "tail log", core.RISK_LEVEL_LOW,
...
func TestRegistryCall(t *testing.T) {
	r := action.NewRegistry()
	action.RegisterFunc(r, "add_todo", "add todo", core.RISK_LEVEL_LOW,
