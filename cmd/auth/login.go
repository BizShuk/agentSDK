...
import (
	...
	"github.com/bizshuk/agentsdk/auth/provider/anthropic"
	"github.com/bizshuk/agentsdk/auth/provider/antigravity"
	"github.com/bizshuk/agentsdk/auth/provider/openai"
...
func announce(root *rootFlags, id string, authenticator sdkauth.Authenticator) {
	...
	case sdkauth.KIND_OAUTH:
		...
		// device flow: 沒有 redirect,user code 由 auth.PrintDeviceCode 印出。
