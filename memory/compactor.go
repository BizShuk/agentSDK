...
//
// The trivial implementation is HeadlineCompactor (no LLM call), useful for
// tests. Production-grade LLM-driven summarization lives in M4 once the
// anthropic / google providers are wired.
